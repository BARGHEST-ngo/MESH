...
replace (
	...
	// Use AWG-enabled tailscale.com fork from the MESH monorepo subdirectory
	tailscale.com => github.com/BARGHEST-ngo/MESH/mesh-linux-macos-analyst v0.0.0-20260123110416-3fc1972eac80
)
