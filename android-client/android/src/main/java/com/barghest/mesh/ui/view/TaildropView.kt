...
import com.barghest.mesh.ui.util.Lists.SectionDivider
import com.barghest.mesh.ui.util.set
import com.barghest.mesh.ui.viewModel.TaildropViewModel
import com.barghest.mesh.ui.viewModel.TaildropViewModelFactory
...
fun FileShareConnectView(onToggle: () -> Unit) {
  Column(
      ...
      horizontalAlignment = Alignment.CenterHorizontally) {
        Text(
            stringResource(R.string.connect_to_your_MESH_to_share_files),
            style = MaterialTheme.typography.titleMedium)
