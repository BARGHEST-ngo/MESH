...
func initLogging(appCtx AppContext) {
	// Ensure Go runtime prints stacks on fatal/panic
	// "crash" gives better tombstones than "all"
	os.Setenv("GOTRACEBACK", "crash")
	// Enable GC debugging to help diagnose bulkBarrierPreWrite issues
	os.Setenv("GODEBUG", "gctrace=1,madvdontneed=0")
