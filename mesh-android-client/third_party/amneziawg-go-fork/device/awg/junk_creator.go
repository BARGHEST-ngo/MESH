...
func (jc *JunkCreator) randomPacketSize() int {
	...
	if jc.randomGenerator == nil || jc.randomGenerator.cha8Rand == nil {
		panic("JunkCreator.randomPacketSize: randomGenerator is nil - JunkCreator was not initialized with NewJunkCreator()")
	}
...
func (jc *JunkCreator) AppendJunk(writer *bytes.Buffer, size int) error {
	// DEBUG: Check if randomGenerator is initialized
	if jc.randomGenerator == nil || jc.randomGenerator.cha8Rand == nil {
		panic("JunkCreator.AppendJunk: randomGenerator is nil - JunkCreator was not initialized with NewJunkCreator()")
	}
...
func (jc *JunkCreator) randomJunkWithSize(size int) []byte {
	// DEBUG: Check if randomGenerator is initialized
	if jc.randomGenerator == nil || jc.randomGenerator.cha8Rand == nil {
		panic("JunkCreator.randomJunkWithSize: randomGenerator is nil - JunkCreator was not initialized with NewJunkCreator()")
	}
