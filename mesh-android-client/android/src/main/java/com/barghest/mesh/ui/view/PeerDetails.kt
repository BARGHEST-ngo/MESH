...
import com.barghest.mesh.ui.viewModel.PeerDetailsViewModel
import com.barghest.mesh.ui.viewModel.PeerDetailsViewModelFactory
      ...
      Scaffold(
        ...
        LazyColumn(
          ...
          item(key = "tailscaleAddresses") {
            Lists.MutedHeader(stringResource(R.string.mesh_address))
          }
