...
func (peer *Peer) SendBuffers(buffers [][]byte) error {
	...
	if peer == nil {
		panic("SendBuffers: peer is nil")
	}
	if peer.device == nil {
		panic("SendBuffers: peer.device is nil")
	}
	if peer.device.net.bind == nil {
		panic("SendBuffers: peer.device.net.bind is nil")
	}
	if endpoint == nil {
		panic("SendBuffers: endpoint is nil")
	}
	if buffers == nil {
		panic("SendBuffers: buffers is nil")
	}
